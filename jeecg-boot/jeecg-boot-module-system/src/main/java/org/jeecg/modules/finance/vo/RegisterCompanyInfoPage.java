 ...
 */
@Data
@ApiModel(value="register_company_infoPage对象", description="注册公司信息表")
public class RegisterCompanyInfoPage {
...
/*	@Excel(name = "时间数值", width = 15)
	...
	@ExcelCollection(name="股东信息")
	@ApiModelProperty(value = "股东信息")
	private List<RegisterShareHolder> registerShareHolderList;
